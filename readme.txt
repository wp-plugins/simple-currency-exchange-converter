...
Contributors: tyggis
Donate link:
Tags: valuta, currency, converter, money, exchange, currency converter, currency conversion, currency calculator, foreign exchange conversion, fx rate converter
...
You can add the code echo shortcode_valutakalkulator() in the template if you prefer that.x
